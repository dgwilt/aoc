...
7 A, 1 C => 1 D
7 A, 1 D => 1 E
7 A, 1 E => 1 FUEL""","""9 ORE => 2 A
8 ORE => 3 B
7 ORE => 5 C
3 A, 4 B => 1 AB
5 B, 7 C => 1 BC
4 C, 1 A => 1 CA
2 AB, 3 BC, 4 CA => 1 FUEL""","""157 ORE => 5 NZVS
165 ORE => 6 DCFZ
...
165 ORE => 2 GPVTF
3 DCFZ, 7 NZVS, 5 HKGWZ, 10 PSHF => 8 KHKGT""","""2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
...
def run(data):
    ...
    return calc_ore(1,stock,graph,amounts)
