...
class AocDay11(AocDay):
    ...
    def run_silver(self,data):
        ...
        return AocDay11.count_simple_paths(G,reverse_topo,"you","out")
...
hhh: out""",""""""]
    ...
    data = """jcy: qqq xzi wqn tga eoa dki jjn xyo ywb kor ous mni gkm
ewa: qww tln
wns: lin
ldh: rnx zzx tpx
opp: xed
