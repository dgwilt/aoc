...
class AocDay6(AocDay):
    ...
    def run_op(self,data,op):
        return sum(len(op(*(set(person) for person in group.splitlines()))) for group in data.split("\n\n"))

    def run_silver(self,data):
        return self.run_op(data,set.union)

    def run_gold(self,data):
        return self.run_op(data,set.intersection)

if __name__ == "__main__":

    data = """rypdeiqkbgacnxwumhtozfjvs
