...
class AocDay1(AocDay):
    ...
    def first_and_last_in_line(self,items,line):
        firstpos, lastpos = len(line), -1
        first, last = "", ""
        for i in items:
            lpos = line.find(i)
            if lpos != -1 and lpos < firstpos:
                first, firstpos = i,lpos

            rpos = line.rfind(i)
            if rpos != -1 and rpos > lastpos: 
                last, lastpos = i,rpos
    ...
    def run_silver(self,data):
        ...
        for line in data.splitlines():
            n1,n2 = self.first_and_last_in_line(digits,line)
            total += int(n1+n2)
    ...
    def run_gold(self,data):
        ...
        for line in data.splitlines():
            items = list(digits.keys()) + list(digits.values())
            n1,n2 = self.first_and_last_in_line(items,line)
