...
class AocDay2(AocDay):
    ...
    def run_silver(self,data):
        ...
        for line in data.splitlines():
            ...
            if all(n <= maxcubes[c] for n,c in self.parser(cubes)):
                total += gid
        return total
    ...
    def run_gold(self,data):
        ...
        for line in data.splitlines():
            ...
            for n,c in self.parser(line.split(": ")[1]):
                maxcubes[c] = max(n,maxcubes[c])
            total += prod(maxcubes.values())

        return total

if __name__ == "__main__":

    silver_tests = ["""Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
...
Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green""",""""""]
    ...
    data = """Game 1: 4 red, 5 blue, 9 green; 7 green, 7 blue, 3 red; 16 red, 7 blue, 3 green; 11 green, 11 blue, 6 red; 12 red, 14 blue
